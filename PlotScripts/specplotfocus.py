...
def gapdensity():
	...
	for x in range(2789,2809):   
	    data3.append(data[x])
	    data4.append(data2[x])
	    
	ax1.scatter(data3, data4, color='blue', marker=".")
	...
	ax1.set_xlim([2790,2810])
	a = float(min(data4))
	b = float(max(data4))
	ax1.set_ylim([-b-0.1,b+0.1])
...
plt.savefig('SpecPlotFocus.pdf', bbox_inches='tight')
#show()
